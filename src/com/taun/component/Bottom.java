...
public class Bottom extends javax.swing.JPanel {
    ...
    public Bottom() {
        initComponents();
        setOpaque(false);
        setBackground(new Color(208, 68, 118));
    }
    ...
    private void initComponents() {
        ...
        play1 = new com.taun.component.Play();
        slider1 = new com.taun.swing.Slider();
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/taun/main/icon/speaker.png"))); // NOI18N
        jButton1.setContentAreaFilled(false);
        jButton1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/taun/main/icon/love_bot.png"))); // NOI18N
        jButton2.setContentAreaFilled(false);
        jButton2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/taun/main/icon/repeat.png"))); // NOI18N
    ...
    private com.taun.component.Play play1;
    private com.taun.swing.Slider slider1;
